...
const MobileNav = ({
  ...
  const dashboardPageIcon = onDashboardPage ? "#2EB875" : "#292D32";
  ...
  return (
    ...
    >
      ...
      <section className="mobile-items m-8" onClick={handleDashboardClick}>
        {/* <FontAwesomeIcon icon={faDashboard} fill={dashboardPageIcon} className="h-5 w-5"/> */}
        <svg
          viewBox="0 0 24 24"
          className="h-5 w-5"
          fill={dashboardPageIcon}
