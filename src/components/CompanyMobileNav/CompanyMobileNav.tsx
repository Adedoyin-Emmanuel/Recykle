...
interface CompanyMobileNavProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
...
const CompanyMobileNav = ({
  ...
  onSettingsPage,
  ...others
}: CompanyMobileNavProps): JSX.Element => {
  const dashboardPageIcon = onDashboardPage ? "#2EB875" : "#292D32";
  const profilePageIcon = onProfilePage ? "#2EB875" : "#292D32";
  const servicePageIcon = onServicePage ? "#2EB875" : "#292D32";
  const settingsPageIcon = onSettingsPage ? "#2EB875" : "#292D32";
  ...
  return (
    ...
    >
      ...
      <section className="mobile-items m-8" onClick={handleServiceClick}>
        <svg
          viewBox="0 0 24 24"
          className="h-5 w-5"
          fill={servicePageIcon}
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
      ...
      <section className="mobile-items m-8" onClick={handleSettingsClick}>
        <svg
          className="h-5 w-5"
          viewBox="0 0 24 24"
          fill={settingsPageIcon}
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
